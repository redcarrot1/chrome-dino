...
public class Birds {
    ...
    private static class Bird {
        ...
        private double x;
        private final int y;
        private final Animation birdFly;
    ...
    private final int WINGS_DOWN_HEIGHT = getImage("resources/bird-1.png").getHeight();
    ...
    public boolean createBird() {
        if (Math.random() * 100 < eManager.getBirdsPercentage()) {
            ...
            birdFly.addSprite(getImage("resources/bird-1.png"));
            birdFly.addSprite(getImage("resources/bird-2.png"));
